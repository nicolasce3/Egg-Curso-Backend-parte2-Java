 ...
 */
package mainejerciciorelaciones3;
 ...
 */
public class MainEjercicioRelaciones3 {
    ...
    public static void main(String[] args) {
        ...
        Baraja baraja = new Baraja(); // Crear una instancia de Baraja
        ServicioBaraja servicio = new ServicioBaraja();
        
        servicio.crearBaraja(baraja); // Pasar la instancia de Baraja al método crearBaraja
        ArrayList<Carta> listaCartas = baraja.getCartas();
        
        
   
        Usuario usuario = new Usuario();
        ArrayList<Carta> barajaUsuario = usuario.getUsuario();
       
        servicio.menu(listaCartas, barajaUsuario);
